...
Wall or static obstacle (impassable)

. or 1

Standard terrain with movement cost 1

2-9

Difficult terrain with the corresponding movement cost

D

Dynamic obstacle used for replanning simulations
